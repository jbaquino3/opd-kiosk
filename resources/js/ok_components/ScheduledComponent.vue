  ...
  <div>
      <div class="content-header">
          <div class="container-fluid">
              <h3>Scheduled Teleconsultations ({{ this.dateNow | dateOnly }})</h3>
          </div>
          <!-- .content-header -->
                      ...
                      <table class="table table-sm table-bordered table-hover">
                          ...
                          <tbody>
                              ...
                              <tr v-for="pat in followup" :key="pat.tStamp" @click="generate_queue(pat.hpercode, pat.tscode, pat.opdtype)">
                                  <td>{{ pat.schedule | standard_datetime }}</td>
                                  <td>{{ pat.hpercode }}</td>
                                  <td>{{ pat.opdtype }}</td>
                                  <td>{{ pat.fullname }}</td>
                                  <td>{{ pat.tsdesc }}</td>
...
export default {
    ...
    methods: {
        ...
        getScheduledConsultations() {
            axios.get('/api/getScheduledConsultations').then(
                ({data}) => {
                    this.followup = data;
                }
            )
    ...
    created() {
        this.getScheduledConsultations();
        this.getDate();
