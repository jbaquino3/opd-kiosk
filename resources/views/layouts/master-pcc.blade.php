                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                <router-link to="/gen_clinic" class="nav-link">
                                    <i class="nav-icon fas fa-hospital text-blue"></i>
                                    <p>
                                        General Clinics
                                    </p>
                                </router-link>
                                <router-link to="/wellness" class="nav-link">
                                    <i class="nav-icon fas fa-walking text-orange"></i>
                                    <p>
                                        Wellness
                                    </p>
                                </router-link>
                                <router-link to="/screening" class="nav-link">
